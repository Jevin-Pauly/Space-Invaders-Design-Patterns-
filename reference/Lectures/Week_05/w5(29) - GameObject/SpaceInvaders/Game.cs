...
namespace SE456
{
    public class SpaceInvaders : Azul.Game
    {
        ...
        public override void LoadContent()
        {
            ...
            // Yes this Yucky, but all of this should be in a factory anyway

            // Create a game object
            BirdGreen pGreenBird = new BirdGreen(SpriteGame.Name.GreenBird, 100.0f, 500.0f);
            // Attach it to the gameObjectManager
            GameObjectNodeMan.Attach(pGreenBird);
            // Attached to Group
            pSB_Birds.Attach(pGreenBird);

            // Create a game object
            BirdRed pRedBird = new BirdRed(SpriteGame.Name.RedBird, 300, 500.0f);
            // Attach it to the gameObjectManager
            GameObjectNodeMan.Attach(pRedBird);
            // Attached to Group
            pSB_Birds.Attach(pRedBird);

            // Create a game object
            BirdWhite pWhiteBird = new BirdWhite(SpriteGame.Name.WhiteBird, 500.0f, 500.0f);
            // Attach it to the gameObjectManager
            GameObjectNodeMan.Attach(pWhiteBird);
            // Attached to Group
            pSB_Birds.Attach(pWhiteBird);

            // Create a game object
            BirdYellow pYellowBird = new BirdYellow(SpriteGame.Name.YellowBird, 700.0f, 500.0f);
            // Attach it to the gameObjectManager
            GameObjectNodeMan.Attach(pYellowBird);
            // Attached to Group
            pSB_Birds.Attach(pYellowBird);
        ...
        public override void Update()
        {
            ...
            pGameObject = GameObjectNodeMan.Find(GameObject.Name.RedBird);
            Debug.Assert(pGameObject != null);
            pGameObject.y += 1.0f;
            if (pGameObject.y > 600.0f)
            {
                pGameObject.y = 0.0f;
            }

            pGameObject = GameObjectNodeMan.Find(GameObject.Name.YellowBird);
            Debug.Assert(pGameObject != null);
            pGameObject.y += 2.0f;
            if (pGameObject.y > 600.0f)
            {
            ...
            pGameObject = GameObjectNodeMan.Find(GameObject.Name.GreenBird);
            Debug.Assert(pGameObject != null);
            pGameObject.y += 0.50f;
            if (pGameObject.y > 600.0f)
            {
            ...
            pGameObject = GameObjectNodeMan.Find(GameObject.Name.WhiteBird);
            Debug.Assert(pGameObject != null);
            pGameObject.y += 3.0f;
            if (pGameObject.y > 600.0f)
            {
