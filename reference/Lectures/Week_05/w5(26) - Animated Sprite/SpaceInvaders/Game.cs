...
namespace SE456
{
    public class SpaceInvaders : Azul.Game
    {
        ...
        public override void LoadContent()
        {
            ...
            SpriteAnimation pSpriteAnim = new SpriteAnimation(SpriteGame.Name.BlueGhost);

            // attach several images to cycle
            pSpriteAnim.Attach(Image.Name.WhiteBird);
            pSpriteAnim.Attach(Image.Name.PinkGhost);
            pSpriteAnim.Attach(Image.Name.GreenBird);
            pSpriteAnim.Attach(Image.Name.BlueGhost);

            // add AnimationSprite to timer
            TimerEventMan.Add(TimerEvent.Name.SpriteAnimation, pSpriteAnim, 0.5f);
            TimerEventMan.Dump();
