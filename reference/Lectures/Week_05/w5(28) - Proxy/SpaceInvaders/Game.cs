...
namespace SE456
{
    public class SpaceInvaders : Azul.Game
    {
        ...
        public override void LoadContent()
        {
            ...
            for (int i = 0; i < 10; i++)
            {
                SpriteGameProxy pProxy = SpriteGameProxyMan.Add(SpriteGame.Name.YellowBird);
                pProxy.x = 50.0f + 70 * i;
                pProxy.y = 100.0f;
        ...
        public override void Update()
        {
            ...
            pSprite = SpriteGameMan.Find(SpriteGame.Name.BlueGhost);
            Debug.Assert(pSprite != null);
            pSprite.Update();

            pSprite = SpriteGameMan.Find(SpriteGame.Name.RedGhost);
            Debug.Assert(pSprite != null);
            pSprite.Update();

            pSprite = SpriteGameMan.Find(SpriteGame.Name.OrangeGhost);
            Debug.Assert(pSprite != null);
            pSprite.Update();

            pSprite = SpriteGameMan.Find(SpriteGame.Name.PinkGhost);
            Debug.Assert(pSprite != null);
            pSprite.Update();

            pSprite = SpriteGameMan.Find(SpriteGame.Name.RedBird);
            Debug.Assert(pSprite != null);
            pSprite.y += 1.0f;
            if (pSprite.y > 600.0f)
            {
            ...
            pSprite = SpriteGameMan.Find(SpriteGame.Name.YellowBird);
            Debug.Assert(pSprite != null);
            pSprite.y += 2.0f;
            if (pSprite.y > 600.0f)
            {
            ...
            pSprite = SpriteGameMan.Find(SpriteGame.Name.GreenBird);
            Debug.Assert(pSprite != null);
            pSprite.y += 0.50f;
            if (pSprite.y > 600.0f)
            {
            ...
            pSprite = SpriteGameMan.Find(SpriteGame.Name.WhiteBird);
            Debug.Assert(pSprite != null);
            pSprite.y += 3.0f;
            if (pSprite.y > 600.0f)
            {
