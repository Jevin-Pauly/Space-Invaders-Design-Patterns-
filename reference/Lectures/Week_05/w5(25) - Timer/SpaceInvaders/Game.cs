...
namespace SE456
{
    public class SpaceInvaders : Azul.Game
    {
        ...
        public override void LoadContent()
        {
            ...
            SampleCommand pCmd1 = new SampleCommand(" -- A  -- ");
            SampleCommand pCmd2 = new SampleCommand(" -- B  -- ");
            SampleCommand pCmd3 = new SampleCommand(" -- C  -- ");
            RepeatCommand pRCmd = new RepeatCommand("Repeat cmd", 2.0f);

            TimerEventMan.Add(TimerEvent.Name.Sample1, pCmd1, 1.0f);
            TimerEventMan.Add(TimerEvent.Name.Sample1, pCmd2, 2.0f);
            TimerEventMan.Add(TimerEvent.Name.Sample1, pCmd3, 3.0f);
            TimerEventMan.Add(TimerEvent.Name.RepeatSample, pRCmd, 2.5f);
        ...
        public override void Update()
        {
            ...
            //Debug.WriteLine("t:{0}", this.GetTime());
