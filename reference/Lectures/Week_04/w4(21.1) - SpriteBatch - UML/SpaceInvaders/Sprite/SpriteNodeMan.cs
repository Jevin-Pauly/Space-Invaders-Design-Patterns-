...
namespace SE456
{
    public abstract class SpriteNodeMan_Link : ManBase
    {
        private SpriteNode_Link Active;
        private SpriteNode_Link Reserve;
        protected SpriteNodeMan_Link(ListBase _poActive, ListBase _poReserve, int InitialNumReserved, int DeltaGrow)
