...
namespace SE456
{
    ...
    {
        SpriteNodeMan pSpriteNodeMan = null;
        float FlySpeed = 2;
        ...
        public override void LoadContent()
        {
            ...
            ImageMan.Create(0, 1);
            SpriteMan.Create(5, 1);

            pSpriteNodeMan = new SpriteNodeMan(0,1);
            ...
            pSpriteNodeMan.Attach(Sprite.Name.RedGhost);
            pSpriteNodeMan.Attach(Sprite.Name.PinkGhost);
            pSpriteNodeMan.Attach(Sprite.Name.BlueGhost);
            pSpriteNodeMan.Attach(Sprite.Name.OrangeGhost);

            pSpriteNodeMan.Attach(Sprite.Name.RedBird);
            pSpriteNodeMan.Attach(Sprite.Name.YellowBird);
            pSpriteNodeMan.Attach(Sprite.Name.GreenBird);
            pSpriteNodeMan.Attach(Sprite.Name.WhiteBird);
