...
namespace SE456
{
    public class SpaceInvaders : Azul.Game
    {
        ...
        public override void LoadContent()
        {
            ...
            SpriteGameMan.Add(SpriteGame.Name.BombStraight, Image.Name.BombStraight, 100, 100, 20, 60);
            SpriteGameMan.Add(SpriteGame.Name.BombCross, Image.Name.BombCross, 100, 100, 20, 60);
            ...
            Bomb pBomb = new Bomb(GameObject.Name.Bomb, SpriteGame.Name.BombZigZag, 700, 700);
            pBomb.ActivateCollisionSprite(pSB_Box);
            pBomb.ActivateSprite(pSB_Birds);
