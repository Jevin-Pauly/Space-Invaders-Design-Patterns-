...
namespace SE456
{
    public class SpaceInvaders : Azul.Game
    {
        ...
        public override void LoadContent()
        {
            ...
            //{
            //    IteratorForwardComposite pIt = new IteratorForwardComposite(pMissileGroup);
            ...
            for (int i = 0; i < 200; i++)
            {
                ...
                TimerEventMan.Add(TimerEvent.Name.MissileSpawn, new MissileSpawnEvent(pRandom), time);
            }
