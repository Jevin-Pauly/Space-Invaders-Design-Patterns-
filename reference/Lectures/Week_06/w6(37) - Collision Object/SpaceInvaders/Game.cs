...
namespace SE456
{
    public class SpaceInvaders : Azul.Game
    {
        ...
        public override void LoadContent()
        {
            ...
            SpriteGameMan.Add(SpriteGame.Name.RedBird, Image.Name.RedBird, 50, 500, 75, 75);
            SpriteGameMan.Add(SpriteGame.Name.YellowBird, Image.Name.YellowBird, 300, 400, 75, 75);
            SpriteGameMan.Add(SpriteGame.Name.GreenBird, Image.Name.GreenBird, 400, 200, 75, 75);
            SpriteGameMan.Add(SpriteGame.Name.WhiteBird, Image.Name.WhiteBird, 600, 300, 75, 75);
            ...
            SpriteGameProxyMan.Dump();

            BirdGrid pGrid = new BirdGrid();
            GameObjectNodeMan.Attach((GameObject)pGrid);

            BirdColumn pColA = new BirdColumn();
            Debug.WriteLine("colA {0}", pColA.GetHashCode());

            BirdColumn pColB = new BirdColumn();
            Debug.WriteLine("colB {0}", pColB.GetHashCode());

            BirdColumn pColC = new BirdColumn();
            Debug.WriteLine("colC {0}", pColC.GetHashCode());

            i = 0;
            pColA.Add(BF.Create(BirdBase.Type.Green, 100.0f + i * 100.0f, 500.0f));
            pColA.Add(BF.Create(BirdBase.Type.Red, 100.0f + i * 100.0f, 400.0f));
            pColA.Add(BF.Create(BirdBase.Type.White, 100.0f + i * 100.0f, 300.0f));
            pColA.Add(BF.Create(BirdBase.Type.Yellow, 100.0f + i * 100.0f, 200.0f));

            i = 1;
            pColB.Add(BF.Create(BirdBase.Type.Green, 100.0f + i * 100.0f, 500.0f));
            pColB.Add(BF.Create(BirdBase.Type.Red, 100.0f + i * 100.0f, 400.0f));
            pColB.Add(BF.Create(BirdBase.Type.White, 100.0f + i * 100.0f, 300.0f));
            pColB.Add(BF.Create(BirdBase.Type.Yellow, 100.0f + i * 100.0f, 200.0f));

            i = 2;
            pColC.Add(BF.Create(BirdBase.Type.Green, 100.0f + i * 100.0f, 500.0f));
            pColC.Add(BF.Create(BirdBase.Type.Red, 100.0f + i * 100.0f, 400.0f));
            pColC.Add(BF.Create(BirdBase.Type.White, 100.0f + i * 100.0f, 300.0f));
            pColC.Add(BF.Create(BirdBase.Type.Yellow, 100.0f + i * 100.0f, 200.0f));
        ...
        public override void Update()
        {
            ...
            GameObject pGrid = GameObjectNodeMan.Find(GameObject.Name.BirdGrid);
            IteratorComposite pIt = new IteratorComposite(pGrid);
