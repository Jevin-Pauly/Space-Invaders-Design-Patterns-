...
namespace SE456
{
    public class SpaceInvaders : Azul.Game
    {
        ...
        public override void LoadContent()
        {
            ...
            i = 0;
            pColA.Add(BF.Create(BirdBase.Type.Green, 500.0f + i * 100.0f, 500.0f));
            pColA.Add(BF.Create(BirdBase.Type.Red, 500.0f + i * 100.0f, 400.0f));
            pColA.Add(BF.Create(BirdBase.Type.White, 500.0f + i * 100.0f, 300.0f));
            pColA.Add(BF.Create(BirdBase.Type.Yellow, 500.0f + i * 100.0f, 200.0f));

            i = 1;
            pColB.Add(BF.Create(BirdBase.Type.Green, 500.0f + i * 100.0f, 500.0f));
            pColB.Add(BF.Create(BirdBase.Type.Red, 500.0f + i * 100.0f, 400.0f));
            pColB.Add(BF.Create(BirdBase.Type.White, 500.0f + i * 100.0f, 300.0f));
            pColB.Add(BF.Create(BirdBase.Type.Yellow, 500.0f + i * 100.0f, 200.0f));

            i = 2;
            pColC.Add(BF.Create(BirdBase.Type.Green, 500.0f + i * 100.0f, 500.0f));
            pColC.Add(BF.Create(BirdBase.Type.Red, 500.0f + i * 100.0f, 400.0f));
            pColC.Add(BF.Create(BirdBase.Type.White, 500.0f + i * 100.0f, 300.0f));
            pColC.Add(BF.Create(BirdBase.Type.Yellow, 500.0f + i * 100.0f, 200.0f));
