...
namespace SE456
{
    public class SpaceInvaders : Azul.Game
    {
        ...
        public override void LoadContent()
        {
            ...
            pColA.Add(BF.Create(GameObject.Name.GreenBird, 250.0f + 50.0f, 200.0f));
            pColA.Add(BF.Create(GameObject.Name.RedBird, 250.0f + 50.0f, 400.0f));
            pColA.Add(BF.Create(GameObject.Name.YellowBird, 250.0f + 50.0f, 250.0f));
