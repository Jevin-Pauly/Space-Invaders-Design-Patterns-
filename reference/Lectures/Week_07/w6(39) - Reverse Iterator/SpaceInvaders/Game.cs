...
namespace SE456
{
    public class SpaceInvaders : Azul.Game
    {
        ...
        public override void LoadContent()
        {
            ...
            pColA.Add(BF.Create(GameObject.Name.GreenBird, 250.0f + 50.0f, 350.0f));
            pColA.Add(BF.Create(GameObject.Name.RedBird, 250.0f + 50.0f, 500.0f));
            pColA.Add(BF.Create(GameObject.Name.YellowBird, 250.0f + 50.0f, 200.0f));

            // Column B
            BirdColumn pColB = (BirdColumn)BF.Create(GameObject.Name.BirdColumn);
            pGrid.Add(pColB);

            pColB.Add(BF.Create(GameObject.Name.GreenBird, 250.0f + 250.0f, 350.0f));
            pColB.Add(BF.Create(GameObject.Name.RedBird, 250.0f + 250.0f, 500.0f));
            pColB.Add(BF.Create(GameObject.Name.YellowBird, 250.0f + 250.0f, 200.0f));
