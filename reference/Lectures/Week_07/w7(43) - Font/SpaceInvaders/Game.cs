...
namespace SE456
{
    public class SpaceInvaders : Azul.Game
    {
        ...
        public override void Initialize()
        {
            ...
            this.SetClearColor(0.184f, 0.184f, 0.18f, 1.0f);
        }
        ...
        public override void LoadContent()
        {
            ...
            FontMan.Add(Font.Name.TestMessage, SpriteBatch.Name.Texts, "ABC", Glyph.Name.Consolas36pt, 500, 500);
            FontMan.Add(Font.Name.TestOneOff, SpriteBatch.Name.Texts, "XYZ1234!#=+ZYX", Glyph.Name.Consolas36pt, 200, 200);
