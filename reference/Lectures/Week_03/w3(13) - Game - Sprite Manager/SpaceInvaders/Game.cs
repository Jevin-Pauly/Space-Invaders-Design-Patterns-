...
namespace SE456
{
    ...
    {
        // I feel dirty
        static public ImageMan pImageMan = null;
        ...
        public override void Initialize()
        {
            ...
            this.SetWindowName("w3(13) Game - Sprite Manager");
        ...
        public override void LoadContent()
        {
            ...
            pImageMan = new ImageMan(new DLinkMan(), new DLinkMan(), 4, 1);
            ...
            Image pHotPink = pImageMan.Add(Image.Name.HotPink, pHotPinkTexture, new Azul.Rect(0, 0, 128, 128));
