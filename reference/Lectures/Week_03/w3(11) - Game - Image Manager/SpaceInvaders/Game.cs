...
namespace SE456
{
    public class SpaceInvaders : Azul.Game
    {
        ...
        public override void Initialize()
        {
            ...
            this.SetWindowName("w3(11) Game - Image Manager");
        ...
        public override void LoadContent()
        {
            ...
            ImageMan pImageMan = new ImageMan(new DLinkMan(), new DLinkMan(), 4, 1);
            Debug.Assert(pImageMan != null);

            Image pImageRedBird = pImageMan.Add(Image.Name.RedBird, pBirdsTexture, new Azul.Rect(47, 41, 48, 46));
            Debug.Assert(pImageRedBird != null);

            Image pImageYellowBird = pImageMan.Add(Image.Name.YellowBird, pBirdsTexture, new Azul.Rect(124, 34, 60, 56));
            Debug.Assert(pImageYellowBird != null);

            Image pImageGreenBird = pImageMan.Add(Image.Name.GreenBird, pBirdsTexture, new Azul.Rect(246, 135, 99, 72));
            Debug.Assert(pImageGreenBird != null);

            Image pImageWhiteBird = pImageMan.Add(Image.Name.WhiteBird, pBirdsTexture, new Azul.Rect(139, 131, 84, 97));
            Debug.Assert(pImageWhiteBird != null);
            ...
            pTmp = pImageMan.Find(Image.Name.GreenBird);
            Debug.Assert(pTmp == pImageGreenBird);

            pTmp = pImageMan.Find(Image.Name.RedBird);
            Debug.Assert(pTmp == pImageRedBird);

            pTmp = pImageMan.Find(Image.Name.WhiteBird);
            Debug.Assert(pTmp == pImageWhiteBird);

            pTmp = pImageMan.Find(Image.Name.YellowBird);
            Debug.Assert(pTmp == pImageYellowBird);
            ...
            //Remove test
            pImageMan.Remove(pImageGreenBird);
            pImageMan.Dump();

            pImageMan.Remove(pImageRedBird);
            pImageMan.Dump();

            pImageMan.Remove(pImageWhiteBird);
            pImageMan.Dump();

            pImageMan.Remove(pImageYellowBird);
            pImageMan.Dump();
