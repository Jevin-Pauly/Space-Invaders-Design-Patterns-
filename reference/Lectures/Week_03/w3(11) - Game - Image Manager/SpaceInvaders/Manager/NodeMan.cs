...
namespace SE456
{
    class NodeMan : ManBase
    {
        ...
        override protected bool derivedCompare(NodeBase pNodeBaseA, NodeBase pNodeBaseB)
        {
            // This is used in baseFind() 
            Debug.Assert(pNodeBaseA != null);
            Debug.Assert(pNodeBaseB != null);

            Node pDataA = (Node)pNodeBaseA;
            Node pDataB = (Node)pNodeBaseB;
        ...
        override protected void derivedWash(NodeBase pNodeBase)
        {
            Debug.Assert(pNodeBase != null);
