...
namespace SE456
{
    public class SpaceInvaders : Azul.Game
    {
        ...
        public override void Initialize()
        {
            ...
            this.SetWindowName("w3(7) Game Engine - One Texture");
        ...
        public override void LoadContent()
        {
            ...
            pRedBird = new Azul.Sprite(pBirdsTex, new Azul.Rect(47, 41, 48, 46), new Azul.Rect(50, 500, 50, 50));
            Debug.Assert(pRedBird != null);

            pYellowBird = new Azul.Sprite(pBirdsTex, new Azul.Rect(124, 34, 60, 56), new Azul.Rect(300, 400, 100, 100));
            Debug.Assert(pYellowBird != null);

            pGreenBird = new Azul.Sprite(pBirdsTex, new Azul.Rect(246, 135, 99, 72), new Azul.Rect(400, 200, 75, 75));
            Debug.Assert(pGreenBird != null);

            pWhiteBird = new Azul.Sprite(pBirdsTex, new Azul.Rect(139, 131, 84, 97), new Azul.Rect(600, 200, 50, 50));
