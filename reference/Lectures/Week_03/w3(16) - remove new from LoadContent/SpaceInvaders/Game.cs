...
namespace SE456
{
    public class SpaceInvaders : Azul.Game
    {
        ...
        public override void Initialize()
        {
            ...
            this.SetWindowName("w3(16) remove new from load content");
        ...
        public override void LoadContent()
        {
            ...
            Texture pBirdsTexture = TextureMan.Add(Texture.Name.Birds, "Birds.t.azul");
            Texture pHotPinkTexture = TextureMan.Add(Texture.Name.HotPink, "HotPink.t.azul");
            ...
            Image pImageRedBird = ImageMan.Add(Image.Name.RedBird, pBirdsTexture, 47, 41, 48, 46);
            Image pImageYellowBird = ImageMan.Add(Image.Name.YellowBird, pBirdsTexture, 124, 34, 60, 56);
            Image pImageGreenBird = ImageMan.Add(Image.Name.GreenBird, pBirdsTexture, 246, 135, 99, 72);
            Image pImageWhiteBird = ImageMan.Add(Image.Name.WhiteBird, pBirdsTexture, 139, 131, 84, 97);

            // --- Hot Pink ---

            Image pHotPink = ImageMan.Add(Image.Name.HotPink, pHotPinkTexture, 0, 0, 128, 128);
