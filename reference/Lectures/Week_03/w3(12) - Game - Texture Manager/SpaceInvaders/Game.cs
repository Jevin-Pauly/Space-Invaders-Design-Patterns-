...
namespace SE456
{
    public class SpaceInvaders : Azul.Game
    {
        ...
        public override void Initialize()
        {
            ...
            this.SetWindowName("w3(12) Game - Texture Manager");
        ...
        public override void LoadContent()
        {
          ...
          //  Debug.Assert(pBirdsTexture != null);
            ...
            Texture pAliensTexture = pTextureMan.Add(Texture.Name.Aliens, "Aliens.t.azul");
            Debug.Assert(pAliensTexture != null);
            ...
            //pTmp = pTextureMan.Find(Texture.Name.Aliens);
            //Debug.Assert(pTmp == pAliensTexture);

            //pTmp = pTextureMan.Find(Texture.Name.Birds);
            //Debug.Assert(pTmp == pBirdsTexture);

            ////Remove test
            //pTextureMan.Remove(pBirdsTexture);
            //pTextureMan.Dump();

            //pTextureMan.Remove(pAliensTexture);
            //pTextureMan.Dump();
