...
namespace SE456
{
    public class SpaceInvaders : Azul.Game
    {
        ...
        public override void Initialize()
        {
            ...
            this.SetWindowName("w2(2) - DLink Manager");
        ...
        public override void LoadContent()
        {
            ...
            Debug.WriteLine("--------------------------\n");
            {
                Node pA = new Node(Node.Name.Bird, 33);
                Node pB = new Node(Node.Name.Cat, 55);
                Node pC = new Node(Node.Name.Dog, 77);

                DLinkMan pMan = new DLinkMan();
                pMan.Dump();
