    ...
    public class SpriteFont : SpriteBase
    {
        ...
        override public void Render()
        {
            ...
            for (int i = 0; i < this.pMessage.Length; i++)
            {
                ...
                xTmp = xEnd + (3 * pGlyph.GetAzulRect().width) / 2;
                this.poScreenRect.Set(xTmp, yTmp, 3 * pGlyph.GetAzulRect().width, 3 * pGlyph.GetAzulRect().height);
                ...
                xEnd = (3 * pGlyph.GetAzulRect().width) / 2 + xTmp;
