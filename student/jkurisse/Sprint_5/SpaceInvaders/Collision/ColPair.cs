...
namespace SE456
{
    public class ColPair : DLink
    {
        ...
        {
            if (this.poSubject.pObjA != this.poCompare.pObjA || this.poSubject.pObjB != this.poCompare.pObjB)
            {
                this.poSubject.Notify();
                this.poCompare.pObjA = this.poSubject.pObjA;
                this.poCompare.pObjB = this.poSubject.pObjB;
            }
