...
namespace SE456
{
    class SpriteMan : ManBase
    {
        ...
        public static void Create(int reserveNum = 3, int reserveGrow = 1)
        {
            ...
            if (psInstance == null)
            {
                psInstance = new SpriteMan(new SLinkMan(), new SLinkMan(), reserveNum, reserveGrow);
            }
        }
        ...
        // Methods
        //----------------------------------------------------------------------
        public static Sprite Add(Sprite.Name name, Image pImage, float x, float y, float w, float h)
        {
            SpriteMan pMan = SpriteMan.privGetInstance();
            Debug.Assert(pMan != null);
