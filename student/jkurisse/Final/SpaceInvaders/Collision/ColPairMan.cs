...
namespace SE456
{
    public class ColPairMan : ManBase
    {
        ...
        {
            ColPairMan pMan = ColPairMan.pActiveColMan;
        ...
        public static void SetActive(ColPairMan pColMan)
        {
            ColPairMan pMan = ColPairMan.privGetInstance();
            Debug.Assert(pMan != null);

            Debug.Assert(pColMan != null);
            ColPairMan.pActiveColMan = pColMan;
        }
        ...
        private static ColPairMan pActiveColMan = null;
