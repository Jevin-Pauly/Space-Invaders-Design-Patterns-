...
namespace SE456
{
    public class GameObjectNodeMan : ManBase
    {
                ...
                : base(new DLinkMan(), new DLinkMan(), reserveNum, reserveGrow)   // <--- Kick the can (delegate)
        {
            ...
            GameObjectNodeMan.psActiveOBMan = null;
        }
        ...
        public static void SetActive(GameObjectNodeMan pOBMan)
        {
            GameObjectNodeMan pMan = GameObjectNodeMan.privGetInstance();
            Debug.Assert(pMan != null);

            Debug.Assert(pOBMan != null);
            GameObjectNodeMan.psActiveOBMan = pOBMan;
        }
        public static void Destroy(bool bPrintEnable = false)
        {
            GameObjectNodeMan pMan = GameObjectNodeMan.psActiveOBMan;
            Debug.Assert(pMan != null);
        ...
        private static GameObjectNodeMan psActiveOBMan = null;
