...
namespace SE456
{
    ...
    {
        // --- Life Visits ---
        public virtual void Visit(LifeRoot l)
        {
            // no differed to subcass
            Debug.WriteLine("Visit by LifeRoot not implemented");
            Debug.Assert(false);
        }

        public virtual void Visit(Life l)
        {
            // no differed to subcass
            Debug.WriteLine("Visit by Life not implemented");
            Debug.Assert(false);
        }

        // --- Bomb Visits ---
        public virtual void Visit(BombRoot u)
        {
            // no differed to subcass
        ...
        public virtual void Visit(Bomb u)
        {
            // no differed to subcass
        ...
        // --- UFO Visits ---
        public virtual void Visit(UFORoot u)
        {
            // no differed to subcass
        ...
        public virtual void Visit(ShieldRoot s)
        {
            // no differed to subcass
