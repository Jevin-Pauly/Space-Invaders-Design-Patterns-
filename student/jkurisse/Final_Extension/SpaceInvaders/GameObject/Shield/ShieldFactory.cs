    ...
    class ShieldFactory
    {
        ...
        public static GameObject CreateShields()
        {
            ...
            for (int i = 0; i < 4; i++)
            {
                ...
                pShieldColumn = pFactory.privCreate(ShieldCategory.Type.Column, GameObject.Name.ShieldColumn);
        ...
        public static void RemoveAll()
        {
            ...
            GameObject removeChild = (GameObject)pShieldRoot.GetLastChild();
            while (removeChild != null)
            {
                removeChild.Remove();
                removeChild = (GameObject)pShieldRoot.GetLastChild();
            }
        }
