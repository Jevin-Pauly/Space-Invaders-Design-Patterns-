    ...
    class AlienFactory
    {
            ...
            if (pGameObjNode != null)
            {
                ...
                switch (type)
                {
                    ...
                    case AlienCategory.Type.Grid:
                        ...
                        ((AlienGrid)pAlien).SetDelta(4.0f);
                        ((AlienGrid)pAlien).SetChange(4.0f);
                        break;
        ...
        public static GameObject CreateAliens()
        {
            ...
            for (int i = 0; i < 11; i++)
            {
                ...
                GameObject pAlienCol = pFactory.privCreate(AlienCategory.Type.Column, GameObject.Name.AlienColumn_0 + i);
        ...
        public static void RemoveAll()
        {
            ...
            GameObject removeChild = (GameObject)pAlienRoot.GetLastChild();
            while (removeChild != null)
            {
                removeChild.Remove();
                removeChild = (GameObject)pAlienRoot.GetLastChild();
            }
        }
